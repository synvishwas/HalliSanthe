...
class SimilarAdapter(
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val img: ImageView   = view.findViewById(R.id.imgSimilar)
        val name: TextView   = view.findViewById(R.id.tvSimilarName)
        val price: TextView  = view.findViewById(R.id.tvSimilarPrice)
    }
